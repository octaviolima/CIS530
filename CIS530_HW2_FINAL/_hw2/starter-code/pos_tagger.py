...
class POSTagger():
    ...
    def inference(self, sequence):
        ...
        methods):
            ...
            - viterbi
        """
        # !!!!!!!! Adjust this flag in `constants.py` !!!!!!!!
        flag = INFERENCE
        ...
        if flag == GREEDY:
            ...
            # !!!!!!!! Adjust this flag accordingly in `constants.py` !!!!!!!!
            type = GREEDY_TYPE
        ...
        # Bigram Beam-k  ------------------------------------------------    
        if flag == BEAM_2:
            k = BEAM_K  # ADJUST THIS IN CONSTANTS.PY
            idxseq = []
            for word in sequence:
                if (word in self.all_words) == True:
                    idxseq.append(self.lexical[:,self.word2idx[word]])
...
if __name__ == "__main__":
    ...
    pos_tagger.get_emissions(); pos_tagger.get_unigrams(); 
    pos_tagger.get_bigrams();   pos_tagger.get_trigrams(); 
    ...
    # df.to_csv("data/test_y.csv", index = False)
